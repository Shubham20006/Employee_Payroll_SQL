...
namespace EmployeePayrollServiceSQL
{
    class EmployeeRepository
    {
                ...
                using (sqlConnection)
                {
                    ...
                    if (sqlDataReader.HasRows)
                    {
                        ...
                        while (sqlDataReader.Read())
                        {
                            ...
                            employeeDataManager.Tax = Convert.ToDouble(sqlDataReader["IncomeTax"]);
                            ...
                            employeeDataManager.PhoneNumber = sqlDataReader["PhoneNumber"].ToString();
                            employeeDataManager.Department = sqlDataReader["EmployeeDepartment"].ToString();
        ...
        public void DisplayEmployeeDetails(SqlDataReader sqlDataReader)
        {
            ...
            employeeDataManager.NetPay = Convert.ToDouble(sqlDataReader["NetPay"]);
            employeeDataManager.Gender = Convert.ToChar(sqlDataReader["Gender"]);
            employeeDataManager.PhoneNumber = sqlDataReader["EmployeePhoneNumber"].ToString();
            employeeDataManager.Department = sqlDataReader["EmployeeDepartment"].ToString();
            employeeDataManager.Address = sqlDataReader["Address"].ToString();
            employeeDataManager.StartDate = Convert.ToDateTime(sqlDataReader["StartDate"]);
            //Display Data
